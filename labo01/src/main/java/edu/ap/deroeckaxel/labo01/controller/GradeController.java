package edu.ap.deroeckaxel.labo01.controller;
...
import edu.ap.deroeckaxel.labo01.jpa.Grade;
import edu.ap.deroeckaxel.labo01.jpa.GradeRepository;
...
public class GradeController {
    ...
    @PostMapping("/grade")
    public String saveGrade(@RequestParam("firstName") String firstName, @RequestParam("lastName") String lastName, @RequestParam("grade") int grade){
